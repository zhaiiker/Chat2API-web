import type { ChatCompletionRequest, ChatCompletionTool } from '../../types'
import type { NormalizedToolDefinition } from '../types'
import type { NormalizedClientToolRequest, NormalizedToolChoice, ToolClientAdapter } from './types'
